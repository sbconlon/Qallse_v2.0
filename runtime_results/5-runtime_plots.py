...
if __name__ == '__main__':
	...
	for hardware in ['Cori', 'PC']:
		...
		for algorithm in ['Parallel', 'Numpy', 'Original']:
			#Must edit input path to work for your environment
			input_path = r'/home/atlas/Qallse_v2/Qallse_v2.0/runtime_results/{}_{}_results/'.format(algorithm.lower(), hardware.lower())
